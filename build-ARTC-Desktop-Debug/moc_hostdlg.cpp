...
struct qt_meta_stringdata_Hostdlg_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Hostdlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Hostdlg_t qt_meta_stringdata_Hostdlg = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Hostdlg"
QT_MOC_LITERAL(1, 8, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "Hostdlg\0on_buttonBox_accepted\0"
};
...
const QMetaObject Hostdlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Hostdlg.data,
      qt_meta_data_Hostdlg,  qt_static_metacall, nullptr, nullptr}
};
...
void *Hostdlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Hostdlg.stringdata0))
