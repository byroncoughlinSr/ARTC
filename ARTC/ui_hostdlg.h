...
public:
    ...
    void setupUi(QDialog *Hostdlg)
    {
        if (Hostdlg->objectName().isEmpty())
            Hostdlg->setObjectName(QString::fromUtf8("Hostdlg"));
        ...
        middleNameTxt->setObjectName(QString::fromUtf8("middleNameTxt"));
        middleNameTxt->setGeometry(QRect(150, 100, 241, 31));
        lastNameTxt = new QTextEdit(Hostdlg);
        lastNameTxt->setObjectName(QString::fromUtf8("lastNameTxt"));
    ...
    {
        Hostdlg->setWindowTitle(QApplication::translate("Hostdlg", "Dialog", 0, QApplication::UnicodeUTF8));
        maleBtn->setText(QApplication::translate("Hostdlg", "&Male", 0, QApplication::UnicodeUTF8));
        femaleBtn->setText(QApplication::translate("Hostdlg", "Female", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("Hostdlg", "First name", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("Hostdlg", "Middle name", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("Hostdlg", "Last name", 0, QApplication::UnicodeUTF8));
        dateEdit->setDisplayFormat(QApplication::translate("Hostdlg", "M/d/yyyy", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("Hostdlg", "Birth date", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
